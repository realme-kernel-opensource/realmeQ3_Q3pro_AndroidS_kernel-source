...
export OPLUS_FEAUTRE_PLMN_AS_OPERATOR_NAME=true
export OPLUS_FEATURE_DISABLE_QCRIL_CUSTOM_ECC=true
...
export OPLUS_FEATURE_MUTE_DETECT=yes
...
export OPLUS_FEATURE_BTAUDIO_LOWLATENCY=yes
export OPLUS_FEATURE_AUDIO_FTM=yes
export OPLUS_FEATURE_AP_LVIMFS=yes
export OPLUS_FEATURE_AEC=yes
export OPLUS_FEATURE_CMCC_VIDEO_RING_VOICE_RX_MUTE=yes
...
export OPLUS_FEATURE_AOD_RAMLESS=yes
export OPLUS_FEATURE_BACKLIGHT_GAMMA=yes
